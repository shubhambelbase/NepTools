...
[![Version](https://img.shields.io/badge/Version-v2.6.7-orange.svg)](https://github.com/shubhambelbase/NepTools/releases)
...
**[Download Latest NepTools APK (v2.6.7)](https://github.com/shubhambelbase/NepTools/releases/latest)**

If you are upgrading from v2.6.1 or earlier, export a backup from Settings before installing,
then restore it afterwards. Releases are now signed with a dedicated release key, so Android
treats them as a different signer from the old debug-key builds and one clean install is
required. See RELEASE_SIGNING.md.

---

## Core Features & Tools

### 1. Bikram Sambat (BS) Calendar, Panchang & Homescreen Widget
...
* **Multi-Currency Tracking**: Manage subscriptions in NPR, USD, INR, EUR, and GBP.
...
* **Offline Local Backup**: Export habits, subscriptions, notes, and events into a portable JSON file.
* **One-Tap Restore**: Restore data safely on any device without cloud dependencies.
...
Designed and developed for Nepal.  
