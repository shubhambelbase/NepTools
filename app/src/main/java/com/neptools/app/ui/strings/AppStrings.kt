...
private val S: Map<String, Pair<String, String>> = mapOf(
    ...
    "tile_loan" to ("ऋण किस्ता" to "Loan EMI"),
    ...
    "tool_bill_s" to ("विद्युत र खानेपानी महसुल" to "NEA Electricity & Water Tariff"),
    ...
    "tool_post_t" to ("हुलाक कोड" to "Postal / Zip Codes"),
    ...
    "tool_loan_t" to ("बैंक ऋण किस्ता तथा मुद्दती" to "Loan EMI & FD Calculator"),
    "tool_loan_s" to ("मासिक किस्ता तथा मुद्दती निक्षेप प्रतिफल" to "Calculate monthly EMI & FD returns"),
    ...
    "bs_year_l" to ("वर्ष" to "Year"),
    "bs_month_l" to ("महिना" to "Month"),
    "bs_day_l" to ("गते" to "Day"),
    ...
    "lang_sub" to ("नेपाली वा अंग्रेजी" to "Nepali or English"),
    "np_digits_t" to ("नेपाली अङ्क" to "Nepali numerals"),
    "np_digits_s" to ("देवनागरी वा अंग्रेजी अङ्क — पूरा एपमा" to "Nepali vs English numerals app-wide"),
    "dark_t" to ("अँध्यारो मोड" to "Dark mode"),
    "dark_s" to ("इन्क नाइट थिम" to "Ink Night theme"),
    ...
    "privacy_v" to ("कुनै खाता आवश्यक छैन · सबै डाटा फोनमै सुरक्षित" to "No account required · 100% private"),
    "ai_sec" to ("एआई सुविधाहरू (आउँदैछ)" to "AI Features (Coming)"),
    "ai_note" to ("देवनागरी ओसीआर र नेपाली भ्वाइस नोट अर्को अपडेटमा।" to "Devanagari OCR & Nepali voice notes in next update."),
    ...
    "overview" to ("सिंहावलोकन" to "OVERVIEW"),
    "details_hdr" to ("विस्तृत" to "DETAILS"),
    "an_today" to ("आजको विश्लेषण" to "Today's Analysis"),
    "an_today_s" to ("अङ्क · समयक्रम · आज" to "Scores · Timeline · Today"),
    "an_chart" to ("जन्म कुण्डली" to "Birth Chart"),
    "an_chart_s" to ("कुण्डली · ग्रह · नक्षत्र" to "Chart · Planets · Nakshatra"),
    "an_dasha" to ("विंशोत्तरी दशा" to "Vimshottari Dasha"),
    "an_dasha_s" to ("महादशा · अन्तर्दशा · प्रत्यन्तर" to "Maha · Antar · Pratyantar"),
    "an_gochar" to ("गोचर" to "Transits"),
    "an_gochar_s" to ("वर्तमान गोचर स्थिति" to "Live transits vs natal"),
    ...
    "dob_ad" to ("जन्म मिति (ई.सं.)" to "Date of Birth"),
    "dob_hint" to ("YYYY-MM-DD" to "YYYY-MM-DD"),
    "tob" to ("जन्म समय" to "Time of Birth"),
    "lat" to ("अक्षांश" to "Latitude"),
    "lon" to ("देशान्तर" to "Longitude"),
    "tz" to ("समय अन्तर (घण्टा)" to "TZ offset (hrs)"),
    ...
    "not_found" to ("कुनै ठेगाना भेटिएन — तल अक्षांश/देशान्तर हातले हाल्नुहोस्" to "No match — enter lat/lon manually below"),
    ...
    "emg_loc_gps" to ("स्थान पत्ता लगाउनुहोस्" to "Detect via GPS"),
    ...
    "emg_loc_locating" to ("स्थान खोजी हुँदै…" to "Detecting GPS…"),
    ...
    "bill_elec" to ("विद्युत महसुल" to "Electricity (NEA)"),
    "bill_water" to ("खानेपानी महसुल" to "Water (KUKL)"),
    "bill_units" to ("विद्युत खपत युनिट" to "Electricity Consumed Units"),
    "bill_units_hint" to ("मासिक खपत युनिट" to "Monthly Units"),
    "bill_meter_cap" to ("मिटर क्षमता" to "Meter Capacity"),
    "bill_nea_sum" to ("नेपाल विद्युत प्राधिकरण बिल विवरण" to "NEA Electricity Bill Summary"),
    ...
    "water_vol_hint" to ("खपत लिटर" to "Consumed Liters"),
    "water_pipe" to ("पाइपको साइज" to "Pipe Size"),
    "water_kukl_sum" to ("काठमाडौं उपत्यका खानेपानी महसुल" to "KUKL Water Tariff Summary"),
    ...
    // postal
    "post_title" to ("हुलाक कोड" to "Postal / Zip Codes"),
    ...
    "fuel_source_head" to ("नेपाल आयल निगम आधिकारिक मूल्य:" to "Official NOC Retail Selling Prices:"),
    ...
    "fuel_amt_hint" to ("रकम (रुपैयाँ)" to "Amount (NRs)"),
    "fuel_lit_hint" to ("इन्धन परिमाण (लिटर)" to "Fuel Quantity (Liters)"),
    "fuel_dist_hint" to ("दूरी (कि.मि.)" to "Distance (km)"),
    "fuel_mil_hint" to ("माइलेज (कि.मि./लिटर)" to "Mileage (km/L)"),
    ...
    "qr_hint_web" to ("वेबसाइट ठेगाना (उदा. www.example.com)" to "Website URL (e.g. www.example.com)"),
    "qr_hint_ph" to ("फोन नम्बर" to "Phone Number"),
    "qr_hint_wifi_s" to ("वाइफाइको नाम" to "Wi-Fi SSID (Network Name)"),
    ...
    "onb_lang_hint" to ("नेपाली वा अंग्रेजी छान्नुहोस्। सेटिङबाट पछि परिवर्तन गर्न सकिन्छ।" to "Select Nepali or English. You can change this anytime from Settings."),
