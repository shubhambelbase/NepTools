...
private val S: Map<String, Pair<String, String>> = mapOf(
    ...
    "fuel_by_amt" to ("रकम अनुसार" to "By Amount"),
    "fuel_by_lit" to ("लिटर अनुसार" to "By Liters"),
    "fuel_trip_head" to ("यात्रा खर्च अनुमान" to "Trip Cost Estimator"),
    "fuel_trip_sub" to ("दूरी र माइलेज अनुसार इन्धन खर्च हिसाब" to "Fuel required & cost for your journey"),
    "fuel_preset_bike" to ("बाइक (३५)" to "Bike (35)"),
    "fuel_preset_scooter" to ("स्कूटर (४०)" to "Scooter (40)"),
    "fuel_preset_car" to ("कार (१४)" to "Car (14)"),
